    ...
    return (
      <header className='header wrapper'>
        ...
        <p className='headerTagline'>
          Visualize <a href='http://sass-lang.com/documentation/Sass/Script/Functions.html#hsl_functions' target='_blank' rel='noopener noreferrer'>Sass HSL color functions</a> in real-time without compiling. Made by <a href='http://jim-nielsen.com/'>Jim</a> <a href='http://twitter.com/jimniels'>Nielsen</a>. Code’s on <a href='http://github.com/jimniels/sassme'>Github</a>. Do the same thing but in  CSS at <a href='https://colorme.io/' target='_blank' rel='noopener noreferrer'>ColorMe.io</a>.
        </p>
      </header>
    );
  }
